...
import org.python.pydev.django_template_editor.editors.outline.DjangoContentOutlinePage;
...
public class DjangoEditor extends TextEditor implements IPropertyChangeListener {
	...
	protected void initializeKeyBindingScopes() {		
		setKeyBindingScopes(new String[] { "org.python.pydev.django_template_editor.context.djangoEditorScope" });  //$NON-NLS-1$
